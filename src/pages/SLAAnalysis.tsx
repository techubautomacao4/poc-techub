...
const SLAAnalysis: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">Análise de SLA</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
                    <h3 className="text-lg font-semibold mb-6 text-zinc-900 dark:text-zinc-100">Evolução do SLA (%)</h3>
                ...
                <div className="space-y-6">
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col justify-center h-[140px]">
                        <span className="text-zinc-500 text-sm font-medium">SLA Médio (Mês)</span>
                        <div className="flex items-baseline gap-2 mt-2">
                            <span className="text-4xl font-bold text-zinc-900 dark:text-zinc-100">96.4%</span>
                    ...
                    <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm flex flex-col justify-center h-[140px]">
                        ...
                        <div className="flex items-baseline gap-2 mt-2">
                            ...
                            <span className="text-sm font-medium text-zinc-500">de 24 POCs</span>
                        </div>
                    </div>
                </div>
            </div>
