    ...
    const navItems = [
        {
            ...
            roles: ['ADMIN', 'ANALISTA', 'COMERCIAL']
        },
        {
            label: 'Agenda',
            path: '/calendar',
    ...
    return (
        <div className="flex h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 overflow-hidden font-sans">
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ? "bg-techub-green/10 text-techub-green-dark dark:text-techub-green"
                            ...
                            >
                                <Icon className={cn(
                                    ...
                                    isActive ? "text-techub-green-dark dark:text-techub-green" : "text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-zinc-100"
                                )} />
                                <span className={cn(
                    ...
                    <div className={cn("flex items-center gap-3", !isSidebarOpen && "justify-center")}>
                        ...
                        {isSidebarOpen && (
                            <button
                                ...
                                className="p-1.5 rounded-md hover:bg-red-50 dark:hover:bg-red-900/20 text-zinc-400 hover:text-red-600 transition-colors"
                                title="Sair"
                            >
            ...
            <main className="flex-1 flex flex-col min-w-0 transition-all duration-300">
                <header className="h-16 px-8 flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/50 backdrop-blur-sm sticky top-0 z-10">
                    <button
